  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white">Screenshot Protection</h1>
          <p className="text-white/40 text-sm mt-1">Block screenshots on specific screens</p>
        </div>
        <button
          onClick={() => saveMutation.mutate({ allowScreenshots: currentAllow, screenshotBlockedScreens: currentBlocked })}
      ...
      <div className="glass-card p-5 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-white font-semibold">Global Toggle</h2>
            <p className="text-white/40 text-xs">Allow or block screenshots app-wide</p>
          </div>
        </div>
